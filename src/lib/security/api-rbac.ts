...
export const API_RBAC_RULES: ApiRule[] = [
  ...
  { prefix: "/api/inbound-calls", permissions: ["communications:read"], any: true },
  { prefix: "/api/agents/health", permissions: ["orchestrator:read"] },
  { prefix: "/api/agents/coordination-mock", permissions: ["orchestrator:read"] },
